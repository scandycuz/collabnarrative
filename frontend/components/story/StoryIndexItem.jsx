  ...
  truncateText() {
    ...
    for (let i = 0; i < containers.length; i ++) {
      ...
      while ($p.outerHeight() > height) {
        let $body = $p.find("span:nth-child(2)");
  ...
  render() {
    ...
    return (
      <div className="story-item item span-4 group">
        <div className="story box-padding light-border med-radius group">
        ...
        <div className="story-info box-padding light-border med-radius parent">
